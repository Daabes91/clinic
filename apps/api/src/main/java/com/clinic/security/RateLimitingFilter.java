...
public class RateLimitingFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(path.startsWith("/api/public/auth")
                || path.startsWith("/api/public/book")
                || path.startsWith("/api/public/bookings")
    ...
    private SecurityProperties.Bucket resolveBucketConfig(String path) {
        ...
        } else if (path.startsWith("/api/public/book") || path.startsWith("/api/public/bookings") || path.startsWith("/api/public/availability")) {
